-- ============================================
-- SQL para Sistema Biométrico Desktop + Web
...
-- Tabela de biometrias (dados das digitais)
...
VALUES 
  ...
  ('Ayla Andrea Eliane da Silva', 'ayla@example.com', '55', 'Enfermeiro', false, 'ATIVO'),
  ('Victor Benedito Rezende', 'victor@example.com', '49', 'Enfermeiro', false, 'ATIVO'),
  ('Hugo Breno André Silva', 'hugo@example.com', '41', 'Enfermeiro', false, 'ATIVO'),
  ('Thales Iago Kauê de Paula', 'thales@example.com', '33', 'Enfermeiro', false, 'ATIVO')
